...
plt.title(
    'L2 Miss Rate: Chunked vs Simple (L1=64kB, L1_Assoc=8, L2_Assoc=16)',
...
plt.title(
    'Impact of L1 Size on Execution Time (Fixed L2=512kB)',
    fontsize=16, fontweight='bold', pad=20
)
...
plt.title(
    'CPU Efficiency (IPC): Chunked vs Simple (L1=64kB)',
    fontsize=16, fontweight='bold', pad=20
)
...
# ------------------ Plot 4: L1 Hit Rate (ZOOMED CORRECTLY) ------------------
plt.figure(figsize=(12, 7), dpi=100)
...
plt.plot(
    simple_subset['L1_Size'],
    simple_subset['L1_HitRate'],
    marker='o',
    markersize=12,
    linewidth=3.5,
    color='#d62728',
...
plt.plot(
    chunked_subset['L1_Size'],
    chunked_subset['L1_HitRate'],
    marker='s',
    markersize=12,
    linewidth=3.5,
    color='#2ca02c',
...
plt.title(
    'L1 Hit Rate vs L1 Size (Fixed L2=512kB)',
    fontsize=16, fontweight='bold', pad=20
)
plt.ylabel('L1 Hit Rate', fontsize=13, fontweight='bold')
plt.xlabel('L1 Cache Size', fontsize=13, fontweight='bold')

plt.ylim(0.9775, 0.9835)
