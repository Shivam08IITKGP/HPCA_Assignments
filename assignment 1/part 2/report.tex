...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{results/analysis_plots/plot_miss_rate_comparison.png}
    \caption{L2 Miss Rate Comparison between Simple and Chunked variants at baseline configuration.}
    \label{fig:miss_comp}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{results/analysis_plots/plot_ipc_vs_l1d_size.png}
    \caption{IPC vs. L1D Cache Size. Performance improves with larger L1D caches but shows diminishing returns beyond 64kB.}
    \label{fig:ipc_l1d}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{results/analysis_plots/plot_hitrate_l1.png}
    \caption{L1 Cache Hit Rate vs. L1 Size. Both variants show improved hit rates with larger L1 caches.}
    \label{fig:l1_hitrate}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{results/analysis_plots/plot_l1d_hitrate_vs_assoc.png}
    \caption{L1D Hit Rate vs. Associativity. Higher associativity reduces conflict misses, improving hit rates.}
    \label{fig:l1d_assoc}
\end{figure}

\subsection{L2 Cache Behavior Analysis}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{results/analysis_plots/plot_l2_missrate_vs_size.png}
    \caption{L2 Miss Rate vs. L2 Cache Size. Larger L2 caches significantly reduce miss rates, especially for the Simple variant.}
    \label{fig:l2_miss}
\end{figure}
