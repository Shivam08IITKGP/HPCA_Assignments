...
test_binary = os.path.join(project_base, "benchmarks/matrix_multiply")
sweep_output = os.path.join(project_base, "results/full_sweep")
results_file = os.path.join(sweep_output, "full_sweep_results.csv")
...
if __name__ == "__main__":
    ...
    print(f"Starting Full Sweep on {parallel_workers} cores ({len(all_configurations)} total configs)...")
