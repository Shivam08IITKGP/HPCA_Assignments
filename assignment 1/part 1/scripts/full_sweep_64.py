...
BINARY_PATH = os.path.join(ASSIGNMENT_ROOT, "benchmarks/matrix_multiply_64")
OUTPUT_DIR = os.path.join(ASSIGNMENT_ROOT, "results/full_sweep_64")
CSV_FILE = os.path.join(OUTPUT_DIR, "full_sweep_results_64.csv")
...
if __name__ == "__main__":
    ...
    print(f"Starting Full Sweep for 64x64 on {num_workers} cores ({len(configs)} total configs)...")
