...
BINARY_PATH = os.path.join(ASSIGNMENT_ROOT, "benchmarks/matrix_multiply_256")
OUTPUT_DIR = os.path.join(ASSIGNMENT_ROOT, "results/full_sweep_256")
CSV_FILE = os.path.join(OUTPUT_DIR, "full_sweep_results_256.csv")
...
if __name__ == "__main__":
    ...
    print(f"Starting Full Sweep for 256x256 on {num_workers} cores ({len(configs)} total configs)...")
